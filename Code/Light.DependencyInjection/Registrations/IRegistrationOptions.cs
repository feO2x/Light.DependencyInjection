...
namespace Light.DependencyInjection.Registrations
{
    ...
    {
        IRegistrationOptionsForType UseDelegate(Func<object> createInstance);
        IRegistrationOptionsForType UseDelegate<TParameter>(Func<TParameter, object> createInstance);
        IRegistrationOptionsForType UseDelegate<T1, T2>(Func<T1, T2, object> createInstance);
        IRegistrationOptionsForType UseDelegate<T1, T2, T3>(Func<T1, T2, T3, object> createInstance);
        IRegistrationOptionsForType UseDelegate<T1, T2, T3, T4>(Func<T1, T2, T3, T4, object> createInstance);
        IRegistrationOptionsForType UseDelegate<T1, T2, T3, T4, T5>(Func<T1, T2, T3, T4, T5, object> createInstance);
        IRegistrationOptionsForType UseDelegate<T1, T2, T3, T4, T5, T6>(Func<T1, T2, T3, T4, T5, T6, object> createInstance);
        IRegistrationOptionsForType UseDelegate<T1, T2, T3, T4, T5, T6, T7>(Func<T1, T2, T3, T4, T5, T6, T7, object> createInstance);
        IRegistrationOptionsForType UseDelegate<T1, T2, T3, T4, T5, T6, T7, T8>(Func<T1, T2, T3, T4, T5, T6, T7, T8, object> createInstance);
        IRegistrationOptionsForType UseDelegate<T1, T2, T3, T4, T5, T6, T7, T8, T9>(Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, object> createInstance);
        IRegistrationOptionsForType UseDelegate<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, object> createInstance);
    }

    public interface IRegistrationOptionsForType<T> : IBaseRegistrationOptionsForType<IRegistrationOptionsForType<T>>
    {
        IRegistrationOptionsForType<T> UseDelegate(Func<T> createInstance);
        IRegistrationOptionsForType<T> UseDelegate<TParameter>(Func<TParameter, T> createInstance);
        IRegistrationOptionsForType<T> UseDelegate<T1, T2>(Func<T1, T2, T> createInstance);
        IRegistrationOptionsForType<T> UseDelegate<T1, T2, T3>(Func<T1, T2, T3, T> createInstance);
        IRegistrationOptionsForType<T> UseDelegate<T1, T2, T3, T4>(Func<T1, T2, T3, T4, T> createInstance);
        IRegistrationOptionsForType<T> UseDelegate<T1, T2, T3, T4, T5>(Func<T1, T2, T3, T4, T5, T> createInstance);
        IRegistrationOptionsForType<T> UseDelegate<T1, T2, T3, T4, T5, T6>(Func<T1, T2, T3, T4, T5, T6, T> createInstance);
        IRegistrationOptionsForType<T> UseDelegate<T1, T2, T3, T4, T5, T6, T7>(Func<T1, T2, T3, T4, T5, T6, T7, T> createInstance);
        IRegistrationOptionsForType<T> UseDelegate<T1, T2, T3, T4, T5, T6, T7, T8>(Func<T1, T2, T3, T4, T5, T6, T7, T8, T> createInstance);
        IRegistrationOptionsForType<T> UseDelegate<T1, T2, T3, T4, T5, T6, T7, T8, T9>(Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T> createInstance);
        IRegistrationOptionsForType<T> UseDelegate<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T> createInstance);
